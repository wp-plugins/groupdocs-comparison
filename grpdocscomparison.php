...
function grpdocs_comparison_getdocument($atts) {
	...
	$code = '<iframe src="http://apps.groupdocs.com/document-comparison/embed/' . $guid_embed . '/' . $guid_redline . '?referer=wordpress-comparison/1.0.2" frameborder="0" width="'. $width .'" height="'. $height .'">' . $if_no_iframe . '</iframe>';
